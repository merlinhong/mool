<template>
  <div class="card relative z-1001">
    <Toolbar class="!bg-white !py-0">
      ...
      <template #center>
        <div data-edit="menu" :class="['p-5 box-border bottom']"></div>
      </template>
      <template #end>
    ...
    <div
      ...
      "
      class="w-full h-[0] bg-white outline-1 overflow-hidden outline-surface-0/10 text-surface-900 font-bold absolute top-[66px] !z-2000 hidden"
    >
      <div
        class="flex p-4"
      >
